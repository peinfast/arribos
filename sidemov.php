    ...
    <body>
        ...
        <nav class="navbar navbar-default" id="menu">
            <div class="navbar-header">
                ...
                <a href="operacionesmov.php" class="navbar-brand"><img src="assets/img/logo.png" width="100"></a></div>

                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item dropdown">
                        <li><a href="?c=Transporte&a=Editmov">Editar</a></li> 
                        <li><a href="?c=Transporte&a=Clabmov">Registro</a></li>
                    </ul>
