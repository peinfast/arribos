    ...
    <body>
        ...
        <nav class="navbar navbar-default" id="menu">
            <div class="navbar-header">
                ...
                <a href="operacionesl1b.php" class="navbar-brand"><img src="assets/img/logo.png" width="100"></a></div>

                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item dropdown">
                        <li><a href="?c=Transporte&a=Editl1b">Editar</a></li>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action='control/control.php' method='post' enctype="multipart/form-data">
                    ...
                    <br/>
                    <input type='submit' name='submit' class='btn btn-primary' value='Subir archivo'>
                </form>
              </div>
    </div>
  </div>
